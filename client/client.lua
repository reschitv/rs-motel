        ...
        if currentmotel ~= nil then
            ...
            if not inroom then
                ...
                exports['qb-target']:AddCircleZone('enter', vector3(Config.EnterMotelRoom[currentmotel].x, Config.EnterMotelRoom[currentmotel].y, Config.EnterMotelRoom[currentmotel].z), 1.0,{
                    ...
                    options = {{label = Lang:t("motel.enterroom") ,icon = 'fa-solid fa-hand-holding', action = function() TeleportMotel() end}},
                    distance = 2.0
                })
            end  
        end
...
RegisterNetEvent('qb-motel:enterRoom', function()
    EnterMotelRoom()
end)

RegisterNetEvent('qb-motel:exitRoom', function()
    ExitMotelRoom()
end)
...
function TeleportMotel()
    TriggerServerEvent('qb-motel:teleport', GetPlayerServerId(PlayerId()))
end
...
exports['qb-target']:AddCircleZone('exit', vector3(Config.motelDoor.x, Config.motelDoor.y, Config.motelDoor.z), 1.0,{
    ...
    options = {{label = Lang:t("motel.exitroom") ,icon = 'fa-solid fa-hand-holding', action = function() TriggerServerEvent('qb-motel:teleportExit', GetPlayerServerId(PlayerId())) end}},
    distance = 2.0
})
